namespace zood {
    ...
    export class Client {
        ...
        // deleteAccount permanently deletes the account of the logged in user.
        // It requires an access token, so only call it on a Client that was
        // constructed with the token from a successful login.
        deleteAccount(): Promise<void> {
            return new Promise<void>((resolve, reject) => {
                ...
                let endpoint = this.apiBase + "/users/me";
